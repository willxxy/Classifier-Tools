...
state_to_label_mapping = {0: 0, 1: 1, 2: 2} # Very simple mapping, will need to adjust
predicted_labels = [state_to_label_mapping[state] for state in hidden_states]

accuracy = accuracy_score(y_test, predicted_labels)
print(f'Hidden Markov Model Accuracy: {accuracy}')
